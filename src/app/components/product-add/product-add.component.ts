...
export class ProductAddComponent implements OnInit{
  ...
  //Front-End kısmında yapılan validation işlemleri tamamen opsiyonel önemli olan back-end kısmında olması. Burayı kullanıcı geçebilir, back-end üzerinden geçemez.
